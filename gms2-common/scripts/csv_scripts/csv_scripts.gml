...
* @param [cell_delimiter] The delimiter used to separate cells. Defaults to a comma
* @param [string_delimiter] The delimiter used to define strings in the CSV file. Defaults to a double-quote
* @param [mac_newline] Newline compatibility mode for Mac (0xA). Defaults to Windows standard newline (0xDA)
* @return {[]} Array.
*/
